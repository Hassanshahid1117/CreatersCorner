using CreatersCorner.WebApi.Infrastructure.Common.Extensions;
...
namespace CreatersCorner.WebApi.Infrastructure.Localization;

/// <summary>
/// Provides PO files for CreatersCorner Localization.
/// </summary>
public class FSHPoFileLocationProvider : ILocalizationFileLocationProvider
{
    ...
    public IEnumerable<IFileInfo> GetLocations(string cultureName)
    {
        ...
        // for example, src\Host\Localization\en-US\CreatersCorner.Exceptions.po
